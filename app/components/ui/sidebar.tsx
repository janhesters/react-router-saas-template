...
function SidebarProvider({
  ...
  /* oxlint-disable-next-line react/exhaustive-deps -- We need to include setOpenMobile in the dependencies to ensure that the context value is updated when the mobile sidebar is opened or closed. */
  ...
  /* oxlint-disable-next-line react/exhaustive-deps -- We need to include setOpenMobile in the dependenciesd to ensure that the context value is updated when the mobile sidebar is opened or closed. */
