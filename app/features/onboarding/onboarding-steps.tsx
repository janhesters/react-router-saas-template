            ...
            {step.status === "complete" ? (
              ...
              >
                <span className="flex items-center px-6 py-4 text-sm font-medium">
                  <span
                    className={cn(
                      "bg-primary flex size-10 shrink-0 items-center justify-center rounded-full",
              ...
              <Link
                ...
                to={step.href}
              >
                <span className="border-primary/90 flex size-10 shrink-0 items-center justify-center rounded-full border-2">
              ...
              >
                <span className="flex items-center px-6 py-4 text-sm font-medium">
                  <span
                    className={cn(
                      "border-foreground/30 flex size-10 shrink-0 items-center justify-center rounded-full border-2",
