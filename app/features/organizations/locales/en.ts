    ...
    general: {
      ...
      form: {
        ...
        'logo-invalid-mime-type':
          'Invalid file type. Allowed file types are JPG, PNG, and JPEG.',
        'logo-label': 'Organization logo',
        'logo-must-be-url': 'Logo must be a valid URL.',
        'name-description':
          "Your organization's public display name. <1>Warning:</1> Changing the name will break all existing links to your organization.",
        'name-label': 'Organization name',
        'name-max-length':
          'Organization name must be less than 255 characters long.',
        'name-min-length':
