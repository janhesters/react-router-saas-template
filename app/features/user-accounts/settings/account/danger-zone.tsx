...
export function DangerZone({
  ...
  const { t } = useTranslation('user-accounts', {
    keyPrefix: 'settings.user-account.danger-zone',
  });
            ...
            {isDeleteBlocked ? (
              <p className="text-muted-foreground space-y-1 text-sm">
                <Trans
                  ...
                  i18nKey="user-accounts:settings.user-account.danger-zone.blocking-organizations"
                  values={{
                    organizations:
                  ...
                  {hasImplicitDeletions && (
                    <div className="text-muted-foreground text-sm">
                      <Trans
                        ...
                        i18nKey="user-accounts:settings.user-account.danger-zone.implicitly-deleted-organizations"
                        shouldUnescape
                        values={{
                          organizations:
