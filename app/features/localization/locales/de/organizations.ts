export default {
  ...
  jobsAndClients: {
    ...
    candidateProfile: {
      ...
      candidateDetails: "Detaillierte Informationen zum Kandidaten anzeigen",
      candidateImageAlt: "Kandidaten-Profilbild",
      ...
      joinMeeting: "Meeting beitreten",
      linkCopied: "Meeting-Link in die Zwischenablage kopiert",
      othersCount: "+{{count}} weitere",
      resumeHighlights: "Lebenslauf-Highlights",
      skills: "Fähigkeiten",
      time: "Zeit",
    },
    candidateSources: {
