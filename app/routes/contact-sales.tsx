  ...
  return (
    <>
      ...
      <main className="relative isolate mx-auto max-w-7xl px-6 py-8 lg:px-8">
        ...
        >
          <div className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-secondary to-primary opacity-30 clip-ambient-glow sm:left-[calc(50%+36rem)] sm:w-288.75" />
        </div>
      </main>
    </>
  );
